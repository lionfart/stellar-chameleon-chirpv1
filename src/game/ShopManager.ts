...
export class ShopManager {
  ...
  constructor(
    ...
    onOpenShopCallback: (items: ShopItem[], playerGold: number) => void,
    onCloseShopCallback: () => void
  ) {
    this.gameState = gameState;
    this.spriteManager = spriteManager;
    this.soundManager = soundManager;
    this.onOpenShopCallback = onOpenShopCallback;
    this.onCloseShopCallback = onCloseShopCallback;
  }
  ...
  openShop() {
    ...
    this.gameState.isPaused = true; // Pause game when shop is open
  ...
  closeShop = () => {
    ...
    this.gameState.isPaused = false; // Resume game when shop is closed
  ...
  purchaseItem = (itemId: string) => {
    ...
    if (this.gameState.player.spendGold(item.cost)) {
      ...
      this.onOpenShopCallback(this.getAvailableShopItems(), this.gameState.player.gold); // Refresh shop items
    } else {
